  ...
  var a = function(a, n) {
    var r,
        ...
        return (
          (a =
            void 0 === e || null === e
              ...
              ? t(e)
              : C()
              ? t.tz(e, l, n.useStrict, n.timeZone)
              : t(e, l, n.useStrict)),
          C() && a.tz(n.timeZone),
          a
        );
            ...
            e("<tr>")
              .append(
                e("<th>")
                  ...
                  .append(e("<i>").addClass(n.icons.previous))
              )
              .append(
                e("<th>")
              ...
              .append(
                e("<th>")
                  ...
                  .append(e("<i>").addClass(n.icons.next))
              )
          ),
          a = e("<tbody>").append(
            e("<tr>").append(
            ...
            (t.append(
              e("<td>").append(
                e("<a>")
                  ...
                  .append(e("<i>").addClass(n.icons.up))
              )
            ),
            a.append(
              e("<td>").append(
            ...
            r.append(
              e("<td>").append(
                e("<a>")
                  ...
                  .append(e("<i>").addClass(n.icons.down))
              )
            )),
          T("m") &&
            (T("h") &&
      ...
      I = function() {
        var t = e("<div>").addClass(
          ...
          o = e("<li>")
            ...
            .append(H());
        return (
          n.inline && t.removeClass("dropdown-menu"),
          ...
          n.sideBySide && S() && M()
            ? (t.addClass("timepicker-sbs"),
              ...
              t.append(
                e("<div>")
                  .addClass("row")
                  .append(a.addClass("col-md-6"))
                  .append(r.addClass("col-md-6"))
              ),
              "bottom" === n.toolbarPlacement && t.append(o),
              t)
            : ("top" === n.toolbarPlacement && i.append(o),
              S() &&
                i.append(
                  e("<li>")
                    .addClass(n.collapse && M() ? "collapse show" : "")
                    .append(a)
                ),
      ...
      Y = function() {
        ...
        m.css({
          ...
          bottom:
            "top" === o ? t.outerHeight() - (t === a ? 0 : r.top) : "auto",
      ...
      Z = function() {
        ...
        a
          .eq(0)
          .find("span")
          .attr("title", n.tooltips.prevYear),
          a.eq(1).attr("title", n.tooltips.selectYear),
          a
            .eq(2)
            .find("span")
            .attr("title", n.tooltips.nextYear),
      ...
      R = function() {
        ...
        for (
          t
            .eq(0)
            .find("span")
            .attr("title", n.tooltips.prevDecade),
            t.eq(1).attr("title", n.tooltips.selectDecade),
            t
              .eq(2)
              .find("span")
              .attr("title", n.tooltips.nextDecade),
      ...
      Q = function() {
        ...
        for (
          o
            .eq(0)
            .find("span")
            .attr("title", n.tooltips.prevCentury),
            o
              .eq(2)
              .find("span")
              .attr("title", n.tooltips.nextCentury),
            a.find(".disabled").removeClass("disabled"),
            (s.isSame(t({ y: 1900 })) ||
              (n.minDate && n.minDate.isAfter(s, "y"))) &&
              o.eq(0).addClass("disabled"),
            o.eq(1).text(s.year() + "-" + d.year()),
            (s.isSame(t({ y: 2e3 })) ||
              (n.maxDate && n.maxDate.isBefore(d, "y"))) &&
          ...
          (e = s.year() + 12),
            (p =
              n.minDate && n.minDate.isAfter(s, "y") && n.minDate.year() <= e),
            (c =
              n.maxDate && n.maxDate.isAfter(s, "y") && n.maxDate.year() <= e),
            (u +=
        ...
        if (S()) {
          for (
            d
              .eq(0)
              .find("span")
              .attr("title", n.tooltips.prevMonth),
              d.eq(1).attr("title", n.tooltips.selectMonth),
              d
                .eq(2)
                .find("span")
                .attr("title", n.tooltips.nextMonth),
      ...
      G = function() {
        var t = m.find(".timepicker-hours table"),
          ...
          r = e("<tr>");
        for (
          i.hour() > 11 && !s && a.hour(12);
          a.isSame(i, "d") &&
          (s || (i.hour() < 12 && a.hour() < 12) || i.hour() > 11);
      ...
      J = function() {
        for (
          var t = m.find(".timepicker-minutes table"),
            ...
            r = [],
            o = e("<tr>"),
            s = 1 === n.stepping ? 5 : n.stepping;
          i.isSame(a, "h");

        )
          a.minute() % (4 * s) == 0 && ((o = e("<tr>")), r.push(o)),
            o.append(
      ...
      _ = function(e) {
        ...
        if (
          ...
          for (
            e
              .minutes(Math.round(e.minutes() / n.stepping) * n.stepping)
              .seconds(0);
            n.minDate && e.isBefore(n.minDate);
      ...
      ne = {
        ...
        selectYear: function(t) {
          ...
          i.year(a),
            p === h
              ? (_(r.clone().year(i.year())), n.inline || ee())
              : (j(-1), U()),
            B("YYYY");
        },
          ...
          if (o && o.length) {
            ...
            o.collapse
              ...
              r.is("i")
                ...
                : r.find("i").toggleClass(n.icons.time + " " + n.icons.date);
          }
        },
        showPicker: function() {
      ...
      re = function(t) {
        return (
          ...
          (ne[e(t.currentTarget).data("action")].apply(c, arguments), !1)
        );
      },
      ie = function() {
        var t,
        ...
        return o.prop("disabled") ||
          (!n.ignoreReadonly && o.prop("readonly")) ||
          m
          ? c
          : (void 0 !== o.val() && 0 !== o.val().trim().length
              ...
              : u &&
                n.useCurrent &&
                (n.inline || (o.is("input") && 0 === o.val().trim().length)) &&
                ((t = x()),
      ...
      fe = function() {
        ...
        (d = e.replace(/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, function(
          ...
          (l = n.extraFormats ? n.extraFormats.slice() : []).indexOf(e) < 0 &&
            l.indexOf(d) < 0 &&
            l.push(d),
          (s =
    ...
    if (
      ...
      (c.daysOfWeekDisabled = function(e) {
        ...
        if ("boolean" == typeof e && !e)
          return (n.daysOfWeekDisabled = !1), $(), c;
      ...
      (c.defaultDate = function(e) {
        ...
        return (
          (n.defaultDate = t),
          ((n.defaultDate && n.inline) || "" === o.val().trim()) &&
            _(n.defaultDate),
          c
        );
      }),
    ...
    if (
      (a.hasClass("input-group") &&
        (f =
          0 === a.find(".datepickerbutton").length
    ...
    return (
      ...
      e.extend(
        ...
        (function() {
          var t,
            r = {};
          return (
            (t = a.is("input") || n.inline ? a.data() : a.find("input").data())
              .dateOptions &&
      ...
      o.is("input") && 0 !== o.val().trim().length
        ? _(ae(o.val().trim()))
        : n.defaultDate && void 0 === o.attr("placeholder") && _(n.defaultDate),
      n.inline && ie(),
      c
    );
  };
      ...
      if ("object" == typeof t)
        return this.each(function() {
          ...
          r.data("DateTimePicker") ||
            ((n = e.extend(!0, {}, e.fn.datetimepicker.defaults, t)),
